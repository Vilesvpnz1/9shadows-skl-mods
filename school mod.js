(function() {
    ...
    const stylesString = `
        ...
        #dima-api-setup {
            ...
            width: 450px; max-width: 90vw; background: var(--dima-bg-dark);
            border: 2px solid var(--dima-accent); border-radius: 20px;
            box-shadow: 0 25px 50px rgba(0, 0, 0, 0.5), 0 0 30px rgba(var(--dima-accent-rgb), 0.3);
            z-index: 10000001; opacity: 0; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        #dima-api-setup::before {
            content: ''; position: absolute; top: 0; left: 0; right: 0; bottom: 0;
            background: linear-gradient(135deg, 
                rgba(var(--dima-accent-rgb), 0.1) 0%, 
                transparent 30%, 
                rgba(var(--dima-accent-rgb), 0.05) 100%);
            pointer-events: none; z-index: 0;
        }
        #dima-api-header {
            ...
            background: linear-gradient(90deg, 
                var(--dima-bg-light) 0%, 
                rgba(var(--dima-accent-rgb), 0.2) 100%);
            border-bottom: 1px solid rgba(var(--dima-accent-rgb), 0.3); 
            cursor: grab; position: relative; z-index: 1;
            backdrop-filter: blur(10px);
        }
        #dima-api-header:active {
            cursor: grabbing;
        }
        ...
        #dima-api-content {
            padding: 35px 30px; display: flex; flex-direction: column; align-items: center;
            text-align: center; gap: 25px; position: relative; z-index: 1;
        }
        #dima-api-title {
        ...
        #dima-api-instruction {
            font-size: 0.95em; margin-bottom: 0; color: var(--dima-text);
            line-height: 1.6; font-weight: 400; opacity: 0.9;
        }
        #dima-api-input-container {
            display: flex; flex-direction: column; gap: 15px; width: 100%;
        }
        #dima-api-input {
            padding: 12px 16px; background: rgba(var(--dima-bg-light-rgb), 0.8);
            border: 2px solid rgba(var(--dima-accent-rgb), 0.3); border-radius: 10px;
            color: var(--dima-text-bright); font-size: 0.9em; font-family: 'Courier New', monospace;
        ...
        #dima-api-input:focus {
            ...
            box-shadow: 0 0 20px rgba(var(--dima-accent-rgb), 0.3);
        }
        ...
        .dima-api-btn {
            padding: 10px 20px; background: linear-gradient(135deg, 
                rgba(var(--dima-accent-rgb), 0.8) 0%, 
                rgba(var(--dima-accent-rgb), 0.6) 100%);
            border: none; border-radius: 8px; color: var(--dima-text-bright);
        ...
        .dima-api-btn:hover {
            ...
            background: linear-gradient(135deg, 
                rgba(var(--dima-accent-rgb), 1) 0%, 
                rgba(var(--dima-accent-rgb), 0.8) 100%);
        }
        .dima-api-btn.secondary {
            background: linear-gradient(135deg, 
                rgba(var(--dima-border-rgb), 0.4) 0%, 
                rgba(var(--dima-border-rgb), 0.2) 100%);
            border: 1px solid rgba(var(--dima-border-rgb), 0.6);
        }
        .dima-api-btn.secondary:hover {
            background: linear-gradient(135deg, 
                rgba(var(--dima-border-rgb), 0.6) 0%, 
                rgba(var(--dima-border-rgb), 0.4) 100%);
        }
        #dima-instructions-modal {
            position: fixed; top: 0; left: 0; width: 100%; height: 100%;
            background: rgba(0, 0, 0, 0.8); backdrop-filter: blur(10px);
            display: none; align-items: center; justify-content: center;
            z-index: 10000000; opacity: 0; transition: opacity 0.3s ease;
        }
        #dima-instructions-modal.dima-visible {
            opacity: 1; display: flex;
        }
        #dima-instructions-content {
            background: var(--dima-bg-dark); border: 1px solid var(--dima-border);
            border-radius: 16px; padding: 30px; max-width: 600px; width: 90%;
            max-height: 80vh; overflow-y: auto; position: relative;
            box-shadow: 0 20px 40px rgba(0, 0, 0, 0.5);
        }
        #dima-instructions-close {
            position: absolute; top: 15px; right: 20px; background: none; border: none;
            color: var(--dima-text); font-size: 24px; cursor: pointer;
            transition: color 0.3s ease;
        }
        #dima-instructions-close:hover {
            color: var(--dima-accent);
        }
        #dima-instructions-title {
            font-size: 1.8em; font-weight: 700; color: var(--dima-text-bright);
            margin-bottom: 20px; text-align: center;
        }
        .dima-instruction-section {
            margin-bottom: 25px;
        }
        .dima-instruction-section h3 {
            color: var(--dima-accent); font-size: 1.3em; margin-bottom: 10px;
        }
        .dima-instruction-section p {
            color: var(--dima-text); line-height: 1.6; margin-bottom: 10px;
        }
        .dima-instruction-section ul {
            color: var(--dima-text); line-height: 1.6; margin-left: 20px;
        }
        .dima-instruction-section li {
            margin-bottom: 8px;
        }
        .dima-api-example {
            background: rgba(var(--dima-bg-light-rgb), 0.3); border: 1px solid var(--dima-border);
            border-radius: 8px; padding: 15px; margin: 15px 0; font-family: 'Courier New', monospace;
            color: var(--dima-accent); font-size: 0.9em; word-break: break-all;
        }
        #dima-instructions-content::-webkit-scrollbar {
            width: 8px;
        }
        #dima-instructions-content::-webkit-scrollbar-track {
            background: rgba(var(--dima-bg-light-rgb), 0.3);
            border-radius: 4px;
        }
        #dima-instructions-content::-webkit-scrollbar-thumb {
            background: linear-gradient(135deg, var(--dima-accent) 0%, #d63384 100%);
            border-radius: 4px;
            border: 1px solid rgba(var(--dima-accent-rgb), 0.3);
        }
        #dima-instructions-content::-webkit-scrollbar-thumb:hover {
            background: linear-gradient(135deg, #d63384 0%, var(--dima-accent) 100%);
        }
    ...
    const apiSetupHTMLString = `
        <div id="dima-api-setup">
            <div id="dima-api-header">
                <span id="dima-api-header-title">🤖 AI Setup</span>
                <button id="dima-api-close-btn" title="Close">✕</button>
            </div>
            <div id="dima-api-content">
                <div id="dima-api-title">🤖 AI Assistant Setup</div>
                <div id="dima-api-instruction">Enter your API key to enable the AI Assistant. Your key is stored locally and never shared.</div>
                <div id="dima-api-input-container">
                    <input type="password" id="dima-api-input" placeholder="sk-... or gsk_... or sk-ant-...">
                    <div id="dima-api-buttons">
                        <button class="dima-api-btn" id="dima-api-save-btn">Save & Continue</button>
                        <button class="dima-api-btn secondary" id="dima-api-instructions-btn">Instructions</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    const instructionsModalHTMLString = `
        <div id="dima-instructions-modal">
            <div id="dima-instructions-content">
                <button id="dima-instructions-close">✕</button>
                <div id="dima-instructions-title">🔑 How to Get an API Key</div>
                <div class="dima-instruction-section">
                    <h3>Popular AI Service Providers</h3>
                    <p>You can use any of these popular AI services. Note that most API keys require payment, but <strong>Groq API keys are completely free!</strong></p>
                    <ul>
                        <li><strong>OpenAI (GPT-4/GPT-3.5):</strong> Visit <a href="https://platform.openai.com/api-keys" target="_blank" style="color: var(--dima-accent);">platform.openai.com/api-keys</a> - Requires credit card</li>
                        <li><strong>Anthropic (Claude):</strong> Visit <a href="https://console.anthropic.com/" target="_blank" style="color: var(--dima-accent);">console.anthropic.com</a> - Requires credit card</li>
                        <li><strong>Google (Gemini):</strong> Visit <a href="https://makersuite.google.com/app/apikey" target="_blank" style="color: var(--dima-accent);">makersuite.google.com/app/apikey</a> - Requires credit card</li>
                        <li><strong>Groq:</strong> Visit <a href="https://console.groq.com/keys" target="_blank" style="color: var(--dima-accent);">console.groq.com/keys</a> - <span style="color: #98c379; font-weight: bold;">FREE!</span></li>
                        <li><strong>Cohere:</strong> Visit <a href="https://dashboard.cohere.ai/api-keys" target="_blank" style="color: var(--dima-accent);">dashboard.cohere.ai/api-keys</a> - Requires credit card</li>
                    </ul>
                </div>
                <div class="dima-instruction-section">
                    <h3>How to Get Your API Key</h3>
                    <ol>
                        <li>Sign up or log in to your chosen AI service provider</li>
                        <li>Navigate to the API keys or credentials section</li>
                        <li>Create a new API key</li>
                        <li>Copy the generated key (it will look like the example below)</li>
                        <li>Paste it in the input field above</li>
                    </ol>
                </div>
                <div class="dima-instruction-section">
                    <h3>Example API Key Format</h3>
                    <div class="dima-api-example">sk-1234567890abcdef1234567890abcdef1234567890abcdef</div>
                    <p><strong>Note:</strong> API keys are sensitive information. Never share them publicly or commit them to version control.</p>
                </div>
                <div class="dima-instruction-section">
                    ...
                    <ul>
                        ...
                        <li>Each AI provider has different pricing and usage limits</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="dima-card">
                        ...
                        <div id="dima-ai-setup-container">
                            <div style="text-align: center; padding: 40px 20px;">
                                ...
                                <div style="font-size: 1.5em; font-weight: bold; color: var(--dima-text-bright); margin-bottom: 15px;">AI Assistant Setup Required</div>
                                <div style="color: var(--dima-text); margin-bottom: 30px; line-height: 1.6;">To use the AI Assistant, you need to provide your own API key. This ensures privacy and allows you to use any AI service provider you prefer.</div>
                                <button id="dima-ai-setup-btn" style="background: linear-gradient(135deg, var(--dima-accent) 0%, #d63384 100%); border: none; border-radius: 12px; color: white; padding: 15px 30px; font-size: 16px; font-weight: bold; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(224, 108, 117, 0.3);">Setup AI Assistant</button>
                            </div>
                        </div>
    ...
    const scriptParts = [
        ...
        `const instructionsModalHTMLString = ${JSON.stringify(instructionsModalHTMLString)};`,
        ...
        "}",
        "",
        "// Key system dragging - using main panel pattern",
        ...
        "}",
        "",
        "// Global mouse move handler for key dragging",
        ...
        "        window.addAiMessage('assistant', '❌ **API Key Required**\\n\\nPlease set up your API key first by clicking the Setup AI Assistant button.');",
        "        return;",
        "    }",
        "    ",
        ...
        "        ",
        "        if (window.USER_API_KEY.startsWith('sk-')) {",
        "            apiUrl = 'https://api.openai.com/v1/chat/completions';",
        "            model = 'gpt-3.5-turbo';",
        "            headers = {",
        "                'Authorization': `Bearer ${window.USER_API_KEY}`,",
        "                'Content-Type': 'application/json'",
        "            };",
        "        } else if (window.USER_API_KEY.startsWith('gsk_')) {",
        ...
        "                'Content-Type': 'application/json'",
        "            };",
        "        } else if (window.USER_API_KEY.startsWith('sk-ant-')) {",
        "            apiUrl = 'https://api.anthropic.com/v1/messages';",
        "            model = 'claude-3-sonnet-20240229';",
        "            headers = {",
        "                'x-api-key': window.USER_API_KEY,",
        "                'Content-Type': 'application/json',",
        ...
        "        };",
        "        ",
        "        if (window.USER_API_KEY.startsWith('sk-ant-')) {",
        ...
        "window.USER_API_KEY = localStorage.getItem('dima_user_api_key') || '';",
        ...
        "window.aiSetupButton = document.getElementById('dima-ai-setup-btn');",
        "window.aiSetupContainer = document.getElementById('dima-ai-setup-container');",
        "window.aiMainContainer = document.getElementById('dima-ai-main-container');",

        "if (window.USER_API_KEY) {",
        "    if (window.aiSetupContainer) window.aiSetupContainer.style.display = 'none';",
        "    if (window.aiMainContainer) window.aiMainContainer.style.display = 'block';",
        "}",

        "if (window.aiSetupButton) {",
        "    window.aiSetupButton.onclick = function() {",
        "        document.body.appendChild(parseHTML(apiSetupHTMLString));",
        "        document.body.appendChild(parseHTML(instructionsModalHTMLString));",
        "        ",
        "        const apiSetupElement = document.getElementById('dima-api-setup');",
        "        const apiInput = document.getElementById('dima-api-input');",
        "        const apiSaveBtn = document.getElementById('dima-api-save-btn');",
        "        const apiInstructionsBtn = document.getElementById('dima-api-instructions-btn');",
        "        const apiCloseBtn = document.getElementById('dima-api-close-btn');",
        "        const instructionsModal = document.getElementById('dima-instructions-modal');",
        "        const instructionsCloseBtn = document.getElementById('dima-instructions-close');",
        "        const apiHeader = document.getElementById('dima-api-header');",
        "        ",
        "        setTimeout(() => {",
        ...
        "        ",
        "        if (apiHeader) {",
        "            apiHeader.addEventListener('mousedown', function(e) {",
        "                if (e.target.closest('#dima-api-close-btn')) return;",
        "                isDragging = true;",
        "                startX = e.clientX;",
        "                startY = e.clientY;",
        "                const rect = apiSetupElement.getBoundingClientRect();",
        "                initialX = rect.left;",
        "                initialY = rect.top;",
        "                apiSetupElement.style.transition = 'none';",
        "                apiSetupElement.style.transform = 'none';",
        "                apiSetupElement.style.left = initialX + 'px';",
        "                apiSetupElement.style.top = initialY + 'px';",
        "                apiHeader.style.cursor = 'grabbing';",
        "                e.preventDefault();",
        "            });",
        "        }",
        "        ",
        ...
        "            ",
        "            const maxX = window.innerWidth - apiSetupElement.offsetWidth;",
        "            const maxY = window.innerHeight - apiSetupElement.offsetHeight;",
        "            ",
        "            newX = Math.max(0, Math.min(newX, maxX));",
        "            newY = Math.max(0, Math.min(newY, maxY));",
        "            ",
        "            apiSetupElement.style.left = newX + 'px';",
        "            apiSetupElement.style.top = newY + 'px';",
        "        });",
        "        ",
        "        document.addEventListener('mouseup', function() {",
        "            if (isDragging) {",
        "                isDragging = false;",
        "                apiSetupElement.style.transition = 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)';",
        "                if (apiHeader) apiHeader.style.cursor = 'grab';",
        "            }",
        "        });",
        "        ",
        "        if (apiInput) {",
        "            apiInput.focus();",
        "            apiInput.onkeypress = function(e) {",
        "                if (e.key === 'Enter') {",
        "                    apiSaveBtn.click();",
        "                }",
        "            };",
        ...
        "                if (apiKey) {",
        "                    localStorage.setItem('dima_user_api_key', apiKey);",
        "                    window.USER_API_KEY = apiKey;",
        "                    if (apiSetupElement) apiSetupElement.remove();",
        "                    if (window.aiSetupContainer) window.aiSetupContainer.style.display = 'none';",
        "                    if (window.aiMainContainer) window.aiMainContainer.style.display = 'block';",
        "                }",
        "            };",
        "        }",
        "        ",
        "        if (apiInstructionsBtn) {",
        "            apiInstructionsBtn.onclick = function() {",
        "                if (instructionsModal) instructionsModal.classList.add('dima-visible');",
        "            };",
        "        }",
        "        ",
        "        if (instructionsCloseBtn) {",
        "            instructionsCloseBtn.onclick = function() {",
        "                if (instructionsModal) instructionsModal.classList.remove('dima-visible');",
        "            };",
        "        }",
        "        ",
        "        if (apiCloseBtn) {",
        "            apiCloseBtn.onclick = function() {",
        "                if (apiSetupElement) apiSetupElement.remove();",
        "            };",
        "        }",
        "    };",
